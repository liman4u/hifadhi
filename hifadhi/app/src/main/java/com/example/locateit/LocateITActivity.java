...
public class LocateITActivity extends Activity implements
		OnClickListener {
	...
	protected void showCurrentLocation() {
		...
		if (location != null) {
			...
			Toast.makeText(LocateITActivity.this, message,
	...
	private class MyLocationListener implements LocationListener {
		...
		public void onProviderEnabled(String s) {
			Toast.makeText(LocateITActivity.this, "GPS turned on",
					Toast.LENGTH_LONG).show();
		}
